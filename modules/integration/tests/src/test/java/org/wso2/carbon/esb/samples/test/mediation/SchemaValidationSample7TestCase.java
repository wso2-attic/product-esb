...
public class SchemaValidationSample7TestCase extends ESBIntegrationTest {

    @BeforeClass(alwaysRun = true)
    public void setEnvironment() throws Exception {
        super.init();
        loadSampleESBConfiguration(07);
    }

    @Test(groups = "wso2.esb", description = "Add a validate mediator," +
                                             " which validates the first element of the SOAP body of incoming message using the schema")
