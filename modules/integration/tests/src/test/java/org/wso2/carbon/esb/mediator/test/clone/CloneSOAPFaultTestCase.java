 ...
 *
 */
public class CloneSOAPFaultTestCase extends ESBIntegrationTest {
	...
	public void setEnvironment() throws Exception {
        ...
        loadESBConfigurationFromClasspath("/artifacts/ESB/mediatorconfig/clone/clone_SOAP_Fault.xml");
	...
	OMElement response =null;	
	 ...
	 response =  axisServiceClient.sendReceive(createSimpleQuoteRequestBody("IBM"), getMainSequenceURL(), "");
