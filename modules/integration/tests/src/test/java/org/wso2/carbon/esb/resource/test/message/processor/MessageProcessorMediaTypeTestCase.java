...
public class MessageProcessorMediaTypeTestCase {
    ...
    public void init() throws Exception {
        ...
        messageProcessorClient = new MessageProcessorClient(esbServer.getBackEndUrl(), esbServer.getSessionCookie());
        messageStoreAdminClient = new MessageStoreAdminClient(esbServer.getBackEndUrl(), esbServer.getSessionCookie());
