...
public class TracerAdminClient {
	 ...
	 */
	public TracerAdminClient(String backEndUrl, String sessionCookie)
			throws AxisFault {
	 ...
	 * @throws org.apache.axis2.AxisFault
	 */
	public TracerAdminClient(String backEndUrl, String userName, String password)
			throws AxisFault {
		String endPoint = backEndUrl + serviceName;
		tracerAdminStub = new MediationTracerServiceStub(endPoint);
	...
	public String[] getTraceLogs() throws java.rmi.RemoteException {
		try {
			...
			throw new java.rmi.RemoteException(
					"Remote Exception occurred when getTraceLogs" + e);
		}
	}
	...
	public boolean clearTraceLogs() throws java.rmi.RemoteException {
		try {
			...
			throw new java.rmi.RemoteException(
					"Remote Exception occurred when clearTraceLogs" + e);
		}
	}

	public String[] searchTraceLog(String keyword, boolean ignoreCase)
			throws java.rmi.RemoteException,
			org.wso2.carbon.mediation.tracer.stub.client.MediationTracerExceptionException {
		try {
			...
			throw new org.wso2.carbon.mediation.tracer.stub.client.MediationTracerExceptionException(
					"MediationTracerExceptionException occurred when getTraceLogs"
							+ e);
		} catch (java.rmi.RemoteException e) {
			throw new java.rmi.RemoteException(
					"Remote Exception occurred when getTraceLogs" + e);
