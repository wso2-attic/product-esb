...
package org.wso2.esb.integration.common.clients.prioroty.executor;
...
public class PriorityMediationAdminClient {
    ...
    public void addPriorityMediator(String name, OMElement messageProcessorElement) throws RemoteException {
        priorityMediationAdmin.add(name, messageProcessorElement);
    }
