 ...
 */
public class Sample8Test extends ESBIntegrationTestCase {
    ...
    @Test(groups ={"wso2.esb"}, description = "Sample 8: Introduction to static and dynamic registry resources, and using XSLT transformations")
