...
public class Sample351Test extends ESBIntegrationTestCase{
    ...
    @Test(groups = {"wso2.esb"}, description = "Sample 351: In-line script mediation with JavaScript")
    public void testProxyService() throws Exception {

        loadSampleESBConfiguration(351);

        OMElement response = axis2Client.sendCustomQuoteRequest("http://localhost:8280/",
