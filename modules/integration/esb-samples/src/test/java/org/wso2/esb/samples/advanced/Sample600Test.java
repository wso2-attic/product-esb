...
public class Sample600Test extends ESBIntegrationTestCase {
    ...
    @Test(groups = {"wso2.esb"}, description = "Sample 600: Rule mediator as a Filter - Simple rule based routing using an in-lined rule script")
    public void testSimpleURLRewrite() throws Exception {
