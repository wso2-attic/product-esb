 ...
 */
public class Sample0Test extends ESBIntegrationTestCase {
    ...
    @Test(groups ={"wso2.esb"}, description = "Sample 0: Introduction to ESB")
    public void testBasicMediation() throws Exception {
