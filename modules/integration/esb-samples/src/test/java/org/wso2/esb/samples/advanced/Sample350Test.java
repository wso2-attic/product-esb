...
public class Sample350Test extends ESBIntegrationTestCase{
    ...
    @Test(groups = {"wso2.esb"}, description = "Sample 350: Introduction to the script mediator using js scripts")
