...
public class TransformPayloadWhenArgsExpressionTestCase extends ESBIntegrationTestCase {

    public void init() throws Exception {
        loadESBConfigurationFromClasspath("/mediators/payload/factory/expression_arg_payload_factory_synapse.xml");
