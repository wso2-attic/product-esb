...
public class Soap12FaultCodeVersionMismatchedTestCase extends ESBIntegrationTestCase {
    private StockQuoteClient axis2Client;

    public void init() throws Exception {
        axis2Client = new StockQuoteClient();
        String filePath = "/mediators/fault/soap12_fault_code_VersionMismatch_synapse.xml";
