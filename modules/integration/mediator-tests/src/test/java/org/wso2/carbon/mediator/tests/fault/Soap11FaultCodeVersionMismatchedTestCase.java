...
public class Soap11FaultCodeVersionMismatchedTestCase extends ESBIntegrationTestCase {
    private StockQuoteClient axis2Client;

    public void init() throws Exception {
        axis2Client = new StockQuoteClient();
        String filePath = "/mediators/fault/soap11_fault_code_VersionMismatch_synapse.xml";
