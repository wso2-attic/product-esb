...
public class UrlReWriteByPort extends ESBIntegrationTestCase {
    private StockQuoteClient axis2Client;

    public void init() throws Exception {
        axis2Client = new StockQuoteClient();
        String filePath = "/mediators/rewrite/url_reWrite_by_port_synapse.xml";
    ...
    public void invalidUrl() throws AxisFault {
        ...
        try {
            response = axis2Client.sendSimpleStockQuoteRequest(
                    getProxyServiceURL("urlRewriteProxy", false),
                    "abc://localhost:9009/services/SimpleStockQuoteService",
                    "IBM");
