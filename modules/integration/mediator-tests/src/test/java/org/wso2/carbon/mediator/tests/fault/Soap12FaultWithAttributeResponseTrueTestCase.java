...
public class Soap12FaultWithAttributeResponseTrueTestCase extends ESBIntegrationTestCase {
    private StockQuoteClient axis2Client;

    public void init() throws Exception {
        axis2Client = new StockQuoteClient();
        String filePath = "/mediators/fault/soap12_fault_set_response_true_synapse.xml";
