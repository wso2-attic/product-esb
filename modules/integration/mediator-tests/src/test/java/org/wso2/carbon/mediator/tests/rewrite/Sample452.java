...
public class Sample452 extends ESBIntegrationTestCase {
    ...
    @Test(priority = 1, groups = {"wso2.esb"}, description = "Sample 452:  Conditional URL Rewriting with Multiple Rules",
