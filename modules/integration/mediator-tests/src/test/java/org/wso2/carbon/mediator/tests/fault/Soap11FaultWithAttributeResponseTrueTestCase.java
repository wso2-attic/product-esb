...
public class Soap11FaultWithAttributeResponseTrueTestCase extends ESBIntegrationTestCase {
    private StockQuoteClient axis2Client;

    public void init() throws Exception {
        axis2Client = new StockQuoteClient();
        String filePath = "/mediators/fault/soap11_fault_set_response_true_synapse.xml";
