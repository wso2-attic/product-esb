...
public class TransformPayloadWhenNoArgsTestCase extends ESBIntegrationTestCase {
    private StockQuoteClient axis2Client;

    public void init() throws Exception {
        axis2Client = new StockQuoteClient();
        loadESBConfigurationFromClasspath("/mediators/payload/factory/no_arg_payload_factory_synapse.xml");
