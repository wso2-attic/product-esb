...
public class LogMediatorSimpleLevelTestCase extends ESBIntegrationTestCase {
    ...
    public void testSimpleLevelTest() throws IOException, InterruptedException {
        updateESBConfiguration("/simple/synapse.xml");
