...
public class LogMediatorFullLevelTestCase extends ESBIntegrationTestCase {
    ...
    public void testFullLevelLogMediator() throws IOException{

        updateESBConfiguration("/full/synapse.xml");
