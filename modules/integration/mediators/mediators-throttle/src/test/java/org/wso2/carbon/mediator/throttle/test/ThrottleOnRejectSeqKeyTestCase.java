...
public class ThrottleOnRejectSeqKeyTestCase extends ESBIntegrationTestCase{

    private static final Log log = LogFactory.getLog(ThrottleOnRejectSeqKeyTestCase.class);
    ...
    @Test(groups = "wso2.esb", description = "Testing Throttle Mediator success scenario with onReject key Sequence")
    public void testSuccessWithOnRejectSequenceKey() throws Exception{

        OMElement result = null;

        updateESBConfiguration("/throttleOnRejectSeqKey.xml");
