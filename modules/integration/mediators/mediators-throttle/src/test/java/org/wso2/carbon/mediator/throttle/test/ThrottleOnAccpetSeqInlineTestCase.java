...
public class ThrottleOnAccpetSeqInlineTestCase extends ESBIntegrationTestCase{

    private static final Log log = LogFactory.getLog(ThrottleOnAccpetSeqInlineTestCase.class);
    ...
    @Test(groups = "wso2.esb", description = "Testing Throttle Mediator success scenario with onAccept inline Sequence")
    public void testThrottleMediatorInlineSequenceSuccess() throws Exception{

        OMElement result = null;

        updateESBConfiguration("/throttleOnAcceptSeqInline.xml");
    ...
    @Test(groups = {"wso2.esb"}, dependsOnMethods = "testThrottleMediatorInlineSequenceSuccess",
            description = "Testing Throttle Mediator failure scenario with onAccept inline Sequence",
    expectedExceptions = org.apache.axis2.AxisFault.class)
    public void testThrottleMediatorInlineSequenceFailure() throws AxisFault{
