...
public class SendToImplicitEndpointTestCase extends ESBIntegrationTestCase{
    ...
    @Test(groups = "wso2.esb", description = "Test sending request to implicit endpoint")
    public void testSendingToDefinedEndpoint() throws IOException {
        updateESBConfiguration("/none.xml");
