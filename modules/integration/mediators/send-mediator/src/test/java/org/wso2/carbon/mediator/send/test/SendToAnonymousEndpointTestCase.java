...
public class SendToAnonymousEndpointTestCase extends ESBIntegrationTestCase{
    ...
    @Test(groups = "wso2.esb", description = "Test sending request to anonymous endpoint")
    public void testSendingToDefinedEndpoint() throws IOException {
        updateESBConfiguration("/anon.xml");
