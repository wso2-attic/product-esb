...
public class DynamicDefaultEpTestCase extends ESBIntegrationTestCase {

    private static final String ENDPOINT_PATH_1 = "conf:/DynamicDefaultEndpointConf";
    private static final String ENDPOINT_PATH_2 = "gov:/DynamicDefaultEndpointGov";
    ...
    public DynamicDefaultEpTestCase() {
        super("EndpointAdmin");
    }

    @Test(groups ={"wso2.esb"})
    public void testDynamicDefaultEndpoint()
