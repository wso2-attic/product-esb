...
public class DefaultEndpointTestCase extends ESBIntegrationTestCase {

    private static final String ENDPOINT_NAME = "defaultEpTest";

    public DefaultEndpointTestCase() {
        super("EndpointAdmin");
    }

    @Test(groups = {"wso2.esb"})
    public void testDefaultEndpoint() throws RemoteException, EndpointAdminEndpointAdminException {
