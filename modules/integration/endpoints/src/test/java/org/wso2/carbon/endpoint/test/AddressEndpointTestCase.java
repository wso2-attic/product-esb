...
public class AddressEndpointTestCase extends ESBIntegrationTestCase {

    private static final String ENDPOINT_NAME = "addEpTest";

    public AddressEndpointTestCase() {
        super("EndpointAdmin");
    }

    @Test(groups ={"wso2.esb"})
    public void testAddressEndpoint() throws RemoteException, EndpointAdminEndpointAdminException {
