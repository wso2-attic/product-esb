...
public class DynamicInlinedWSDLEpTestCase extends ESBIntegrationTestCase {
    ...
    private static final String ENDPOINT_PATH_1 = "conf:/DynamicInlineWSDLEndpointConf";
    private static final String ENDPOINT_PATH_2 = "gov:/DynamicInlineWSDLEndpointGov";
    private static String ENDPOINT_XML = null;

    public DynamicInlinedWSDLEpTestCase() throws XMLStreamException {
        super("EndpointAdmin");
        ENDPOINT_XML = loadClasspathResource("/wsdlTestEp.xml").toStringWithConsume();
    }
