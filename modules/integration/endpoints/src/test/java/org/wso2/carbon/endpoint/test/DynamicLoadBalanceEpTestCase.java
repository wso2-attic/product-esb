...
public class DynamicLoadBalanceEpTestCase extends ESBIntegrationTestCase {

    private static final String ENDPOINT_PATH_1 = "conf:/DynamicLBEndpointConf";
    private static final String ENDPOINT_PATH_2 = "gov:/DynamicLBEndpointGov";
    private static final String ENDPOINT_XML = "<endpoint xmlns=\"http://ws.apache.org/ns/synapse\" name=\"anonymous\">\n" +
    ...
    public DynamicLoadBalanceEpTestCase() {
        super("EndpointAdmin");
    }

    @Test(groups = {"wso2.esb"})
    public void testDynamicLoadBalanceEndpoint()
