...
public class DynamicFailoverEpTestCase extends ESBIntegrationTestCase {

    private static final String ENDPOINT_PATH_1 = "conf:/DynamicFOEndpointConf";
    private static final String ENDPOINT_PATH_2 = "gov:/DynamicFOEndpointGov";
    ...
    public DynamicFailoverEpTestCase() {
        super("EndpointAdmin");
    }

    @Test(groups ={"wso2.esb"})
    public void testDynamicFailoverEndpoint()
