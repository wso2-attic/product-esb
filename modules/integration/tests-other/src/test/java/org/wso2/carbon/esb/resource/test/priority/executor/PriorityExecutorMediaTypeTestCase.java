...
public class PriorityExecutorMediaTypeTestCase {
    ...
    public void init() throws Exception {
        ...
        priorityMediationAdminClient = new PriorityMediationAdminClient(esbServer.getBackEndUrl(), esbServer.getSessionCookie());
