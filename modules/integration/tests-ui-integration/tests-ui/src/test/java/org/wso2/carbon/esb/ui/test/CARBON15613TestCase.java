...
public class CARBON15613TestCase extends ESBIntegrationUITest {
    ...
    public void testXSSPrevention() throws Exception {
        ...
        LogViewerClient logViewerClient = new LogViewerClient(getBackEndServiceUrl(""), getSessionCookie());
        ...
        driver.findElement(By.id("domain")).sendKeys("carbon15613.com");
        ...
        driver.findElement(By.id("txtUserName")).clear();
        driver.findElement(By.id("txtUserName")).sendKeys("admin@carbon15613.com");
        driver.findElement(By.id("txtPassword")).clear();
    ...
    private void changeESBConfiguration() throws Exception {
        ...
        File configuredCarbonXML = new File(
                getESBResourceLocation() + File.separator + "CARBON15613" + File.separator + File.separator
                        + "carbon-security.xml");
