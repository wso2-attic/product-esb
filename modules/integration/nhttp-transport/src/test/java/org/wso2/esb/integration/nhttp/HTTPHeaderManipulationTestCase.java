...
public class HTTPHeaderManipulationTestCase extends ESBIntegrationTestCase {
    ...
    public void testHttpHeaderManipulation() throws IOException {
        loadESBConfigurationFromClasspath("/http_header.xml");
        axis2Client.addHttpHeader("MyHeader", "TestValue");
        OMElement response = axis2Client.sendSimpleStockQuoteRequest(
                getProxyServiceURL("HeaderManipulationProxy", false),
