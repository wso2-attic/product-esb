...
public class CloneArtifactErrorTestCase extends ESBIntegrationTest {
    ...
    public void TesPatchAutomation1() throws AxisFault {
        ...
        try {
            axis2Client.sendSimpleStockQuoteRequest(getProxyServiceURL("proxyFault1"), null, "WSO2");
        ...
        response1 = axis2Client.sendSimpleStockQuoteRequest(getProxyServiceURL("proxyFault2"),null, "WSO2");
