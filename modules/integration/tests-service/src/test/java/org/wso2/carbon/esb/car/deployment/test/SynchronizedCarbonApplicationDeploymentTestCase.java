...
public class SynchronizedCarbonApplicationDeploymentTestCase extends ESBIntegrationTest {
    ...
    protected void init() throws Exception {
        ...
        applicationAdminClient = new ApplicationAdminClient(esbServer.getBackEndUrl(),
    ...
    public void validSynchronizedCarAppDeploymentTest() throws Exception {
        ...
        CarbonAppUploaderClient carbonAppUploaderClient =
                new CarbonAppUploaderClient(esbServer.getBackEndUrl(), esbServer.getSessionCookie());
        ...
        assertTrue(esbUtils.isEndpointDeployed(esbServer.getBackEndUrl(),
                esbServer.getSessionCookie(), "StockQuoteServiceEp")
                , "StockQuoteServiceEp Endpoint deployment failed");
        assertTrue(esbUtils.isMessageStoreDeployed(esbServer.getBackEndUrl(),
                esbServer.getSessionCookie(), "MyStore")
                , "MyStore Message Store deployment failed");
        assertTrue(esbUtils.isMessageProcessorDeployed(esbServer.getBackEndUrl(),
                esbServer.getSessionCookie(), "ScheduledProcessor")
        ...
        assertTrue(esbUtils.isEndpointUnDeployed(esbServer.getBackEndUrl(),
                esbServer.getSessionCookie(), "StockQuoteServiceEp")
                , "StockQuoteServiceEp Endpoint Un-deployment failure");

        assertTrue(esbUtils.isMessageStoreUnDeployed(esbServer.getBackEndUrl(),
                esbServer.getSessionCookie(), "MyStore")
                , "MyStore Message Store Un-deployment failure");

        assertTrue(esbUtils.isMessageProcessorUnDeployed(esbServer.getBackEndUrl(),
                esbServer.getSessionCookie(), "ScheduledProcessor")
    ...
    public void invalidSynchronizedCarAppDeploymentTest() throws Exception {
        ...
        assertTrue(esbUtils.isMessageStoreUnDeployed(esbServer.getBackEndUrl(),
                esbServer.getSessionCookie(), "MyStore1")
                , "MyStore1 Message Store Un-deployment failure");

        assertTrue(esbUtils.isMessageProcessorUnDeployed(esbServer.getBackEndUrl(),
                esbServer.getSessionCookie(), "ScheduledProcessor1")
