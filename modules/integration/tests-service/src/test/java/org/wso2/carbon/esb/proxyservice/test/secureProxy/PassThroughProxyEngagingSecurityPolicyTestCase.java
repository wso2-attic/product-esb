...
public class PassThroughProxyEngagingSecurityPolicyTestCase extends ESBIntegrationTest {
    ...
    public void setEnvironment() throws Exception {
        ...
        ResourceAdminServiceClient resourceAdmin = new ResourceAdminServiceClient(esbServer.getBackEndUrl(), esbServer.getSessionCookie());
    ...
    public void secureRequestScenario1() throws Exception {
        applySecurity("UTSecureStockQuoteProxyForSecurityEngaging", 1,  getUserRole(userInfo.getUserId()));

        OMElement response = axis2Client.sendSimpleStockQuoteRequest(getProxyServiceURL(proxyName + "1"),
                                                                     null, "Secured");
    ...
    public void secureRequestScenario2() throws Exception {
        ...
        OMElement response = axis2Client.sendSimpleStockQuoteRequest(getProxyServiceURL(proxyName + "2"),
                                                                     null, "Secured");
    ...
    public void secureRequestScenario3() throws Exception {
        ...
        OMElement response = axis2Client.sendSimpleStockQuoteRequest(getProxyServiceURL(proxyName + "3"),
                                                                     null, "Secured");
    ...
    public void secureRequestScenario4() throws Exception {
        ...
        OMElement response = axis2Client.sendSimpleStockQuoteRequest(getProxyServiceURL(proxyName + "4"),
                                                                     null, "Secured");
    ...
    public void secureRequestScenario5() throws Exception {
        ...
        OMElement response = axis2Client.sendSimpleStockQuoteRequest(getProxyServiceURL(proxyName + "5"),
                                                                     null, "Secured");
    ...
    public void secureRequestScenario6() throws Exception {
        ...
        OMElement response = axis2Client.sendSimpleStockQuoteRequest(getProxyServiceURL(proxyName + "6"),
                                                                     null, "Secured");
    ...
    public void secureRequestScenario7() throws Exception {
        ...
        OMElement response = axis2Client.sendSimpleStockQuoteRequest(getProxyServiceURL(proxyName + "7"),
                                                                     null, "Secured");
    ...
    public void secureRequestScenario8() throws Exception {
        ...
        OMElement response = axis2Client.sendSimpleStockQuoteRequest(getProxyServiceURL(proxyName + "8"),
                                                                     null, "Secured");
