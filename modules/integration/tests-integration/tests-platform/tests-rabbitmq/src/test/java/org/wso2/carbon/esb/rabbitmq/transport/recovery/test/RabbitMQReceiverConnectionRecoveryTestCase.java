...
public class RabbitMQReceiverConnectionRecoveryTestCase extends ESBIntegrationTest {
    ...
    @Test(groups = {"wso2.esb"}, description = "Test ESB as a RabbitMQ Consumer with connection recovery - success case", priority = 1)
    ...
    @Test(groups = {"wso2.esb"}, description = "Test ESB as a RabbitMQ Consumer with connection recovery - fail case", priority = 2)
    public void testRabbitMQConsumerRecoveryFailure() throws Exception {
        ...
        Assert.assertEquals(count, 10, "Connection is recovery has an error");
