...
public class NativeTCPClient {
	...
	public void sendToServer() throws Exception {
		...
		for (int i = 0; i < this.messageCount; ++i) {
			...
			} else if (NativeTCPClient.DelimiterTypeEnum.CHARACTER.getDelimiterType().equalsIgnoreCase(this
					.delimiterType)) {
	...
	public String[] receiveCharactorTypeDelimiterResonse() throws Exception {
		...
		} else if (NativeTCPClient.DelimiterTypeEnum.CHARACTER.getDelimiterType().equalsIgnoreCase(this.delimiterType)) {
