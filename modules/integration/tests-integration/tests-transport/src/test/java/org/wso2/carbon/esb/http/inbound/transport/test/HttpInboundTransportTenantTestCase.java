...
public class HttpInboundTransportTenantTestCase extends ESBIntegrationTest{
    ...
    @Test(groups = "wso2.esb", description = "Inbound Http  test case for tenant" , enabled = false)
    ...
    @Test(groups = "wso2.esb", description = "Inbound Http  test case for tenant API dispatching" , enabled = false)
