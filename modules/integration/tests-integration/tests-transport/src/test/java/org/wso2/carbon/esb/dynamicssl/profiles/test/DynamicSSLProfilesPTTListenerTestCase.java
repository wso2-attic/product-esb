...
public class DynamicSSLProfilesPTTListenerTestCase extends ESBIntegrationTest {
    ...
    private String serviceName = "org.apache.synapse:Type=ListenerSSLProfileReloader," +
                                 "Name=PassThroughHttpMultiSSLListener";
    private String configLocation = FrameworkPathUtil.getSystemResourceLocation() + File.separator
                                    + "artifacts"
    ...
    @SetEnvironment(executionEnvironments = {ExecutionEnvironment.STANDALONE})
    @Test(groups = {"wso2.esb"}, description = "Create Mutual SSL Connection with TestProxy with " +
                                               "dynamically loaded SSL configuration")
    ...
    private void invokeJMXMethod() {
        ...
        try {
            jmxClient = new JMXClient(serviceName, "localhost", "11311", "10199", "admin", "admin");
