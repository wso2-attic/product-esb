...
public class ESBJAVA4450TestCase extends ESBIntegrationTest {
    ...
    public void TestDefaultFileType() throws Exception {
        try {
            axis2Client.sendSimpleStockQuoteRequest(getProxyServiceURLHttp("VFSProxyDefault"), null,
                    "WSO2");
    ...
    public void TestBinaryFileType() throws Exception {
        try {
            axis2Client.sendSimpleStockQuoteRequest(getProxyServiceURLHttp("VFSProxyBinary"), null,
                    "WSO2");
        } catch (Exception axisFault) {
            //We expect this as no response is sent to the backend
        }
    ...
    public void TestAsciiFileType() throws Exception {
        try {
            axis2Client.sendSimpleStockQuoteRequest(getProxyServiceURLHttp("VFSProxyAscii"), null,
                    "WSO2");
        } catch (Exception axisFault) {
            //We expect this as no response is sent to the backend
        }
