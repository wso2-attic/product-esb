...
public class JsonFormat_IncomingJson_XmlCTXValue_WithOutStream_TestCase extends ESBIntegrationTest {
    ...
    public void uploadSynapseConfig() throws Exception {
        super.init();
        loadESBConfigurationFromClasspath(File.separator + "artifacts" + File.separator + "ESB" + File.separator + "mediatorconfig" + File.separator + "payload" + File.separator + "factory" + File.separator + "jsonFormat_XmlExpressions_CTX.xml");
    }
