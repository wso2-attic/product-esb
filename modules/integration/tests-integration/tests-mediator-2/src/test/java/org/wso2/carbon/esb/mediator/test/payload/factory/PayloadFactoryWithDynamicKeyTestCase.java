...
public class PayloadFactoryWithDynamicKeyTestCase extends ESBIntegrationTest {
    ...
    private void uploadResourcesToConfigRegistry() throws Exception {
        ...
        ResourceAdminServiceClient resourceAdminServiceStub =
                new ResourceAdminServiceClient(contextUrls.getBackEndUrl(), context.getContextTenant().getContextUser().getUserName() ,context.getContextTenant().getContextUser().getPassword());
