        ...
        try {
           ...
           String change2Value = response.getFirstElement().getFirstChildWithName(new QName
            ...
            if (changeValue.equals(change1Value)) {
                Assert.assertFalse(false, "Response caching worked even with the controller cache in 'in' sequence");
            }
            ...
            Assert.assertEquals(message.getReason(), ESBTestConstant.INCOMING_MESSAGE_IS_NULL
