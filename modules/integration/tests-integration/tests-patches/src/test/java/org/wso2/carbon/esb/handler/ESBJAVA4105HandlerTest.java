...
public class ESBJAVA4105HandlerTest extends ESBIntegrationTest {

    private static final String JAR_NAME = "org.wso2.carbon.test.gateway-1.0.0.jar";
    private static final String JAR_LOCATION = "/artifacts/ESB/synapseconfig/config68/jar";
    private static final String CONF_NAME = "synapse-handlers.xml";
    private static final String CONF_LOCATION = "/artifacts/ESB/synapseconfig/config68";
    ...
    public void setEnvironment() throws Exception {
        ...
        serverConfigurationManager.copyToComponentDropins
                (new File(getClass().getResource(JAR_LOCATION + File.separator + JAR_NAME).toURI()));
        copyToComponentConf(getClass().getResource(CONF_LOCATION + File.separator + CONF_NAME).getPath(), CONF_NAME);
        loadESBConfigurationFromClasspath(File.separator + "artifacts" + File.separator + "ESB"
                                          + File.separator + "synapseconfig" + File.separator + "config68" + File
                .separator + "synapse.xml");
    ...
    public void testSynapseHandlerExecution() throws IOException, EndpointAdminEndpointAdminException,
        ...
        OMElement response = axis2Client.sendSimpleStockQuoteRequest(getProxyServiceURLHttp("SimpleStockQuoteService")
                , null, "WSO2");
    ...
    public void copyToComponentConf(String sourcePath, String fileName) throws IOException, URISyntaxException {
        ...
        String targetPath = carbonHome + File.separator + "repository" + File.separator + "conf";
    ...
    public void destroy() throws Exception {
        serverConfigurationManager.removeFromComponentDropins(getClass().getResource(JAR_LOCATION + File.separator +
                                                                                     JAR_NAME).getPath());
        removeFromComponentConf(getClass().getResource(CONF_LOCATION + File.separator + CONF_NAME).getPath());
        super.cleanup();
    }
